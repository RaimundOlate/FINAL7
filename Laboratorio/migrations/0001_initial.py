# Generated by Django 4.2.2 on 2023-07-17 21:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=255)),
                ('f_fabricacion', models.DateField(validators=[django.core.validators.MinValueValidator('2015-01-01'), django.core.validators.MaxValueValidator('2023-07-17')])),
